...
private:
	...
	// This allows the use of the Color struct
	...
	// define materials used for rendering
	void DefineMaterials();

	// render a composite mesh object
	void RenderCompositeMesh(CompositeMeshObject compositeMesh);
